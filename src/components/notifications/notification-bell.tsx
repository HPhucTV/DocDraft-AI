          ...
          {displayedList.length === 0 ? (
            ...
            displayedList.map((notif: NotificationItem) => (
              <div
                ...
                className={`p-3.5 flex items-start gap-3 hover:bg-muted/40 transition-colors relative cursor-pointer ${
              ...
              >
                ...
                <div className="flex-1 min-w-0 pr-4">
                  <div className="flex items-center justify-between gap-1">
                    <p className={`text-xs font-semibold truncate ${!notif.isRead ? "text-foreground font-bold" : "text-foreground/90"}`}>
                      {notif.title}
                    </p>
